...
export const Search: React.FC<Props> = memo(
    (props) => {
        return (
            <div className='flex items-center w-[100%] px-1 justify-center bg-secondary border-[#9c9c9c] border-2 rounded-md'>
                <input
                    id={"search"}
                    placeholder={`Search`}
                    name={"search"}
                    onChange={props.handleSearch}
                    className="py-2 px-2 w-[100%] rounded-md focus:outline-none text-md font-para bg-secondary "
                />
