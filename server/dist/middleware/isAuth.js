...
var isAuth = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                userId = req.session.uid || ((_a = req.session.passport) === null || _a === void 0 ? void 0 : _a.user);
                if (!userId) {
                    return [2 /*return*/, next(new AppError_1.AppError('Login to access this resource', 400))];
                }
...
var isAdmin = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        if (req.user.role !== 'admin')
            return [2 /*return*/, next(new AppError_1.AppError('You are not authorized to access this resource', 400))];
        next();
        return [2 /*return*/];
    });
}); };
